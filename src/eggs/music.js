export function music(window) {
  ...
  const songs =[
      ...
      },
      {
          ...
          image:'https://i.postimg.cc/PrQ25SgN/im-d799af3821101c78f052ed7871fda05a-removebg-preview.png',
          audio:'HaideVinoInapoi.mp3'
      },
      {
          name:'Baietii si fetele',
          image:'https://i.postimg.cc/d0p9xpyN/Andra-la-debut-removebg-preview.png',
          audio:'BaietiiSiFetele.mp3'
      },
      {
          name:'In lipsa mea',
          image:'https://i.postimg.cc/L5BBhs0G/primul-album-smiley-in-lipsa-mea-poate-fi-ascultat-de-astazi-pe-canalul-de-youtube-al-artistului-1-s.png',
  ...
  const oldMusic = (random) => {
      ...
      discoBall.src="https://bestanimations.com/media/mirror-balls/645938848animated-disco-ball-5-2.gif";
              ...
              (function (x) {
                  window.setTimeout(function () {
                      ...
                      if (x % 2 === 0) {
                          ...
                          img.style.transform=`translate(${Math.floor(Math.random()*520-260)}px, ${Math.floor(Math.random()*520-260)}px)`;
                          bg.style.background="#"+Math.floor(Math.random()*16777215).toString(16);
                          title.style.background="#"+Math.floor(Math.random()*16777215).toString(16);
